const sidebarComponentItems = [
  {
    ...
    link: "/advance-ui",
    sublinks: [
      { text: "Sweet Alert", link: "/sweet-alert" },
      { text: "Nestable List", link: "/nestable-list" },
      { text: "Animation", link: "/animation" },
      { text: "Swiper Slider", link: "/swiper-slider" },
    ],
  },
  { text: "Forms", link: "/form", sublinks: [] },
  { text: "Tables", link: "/table", sublinks: [] },
  { text: "Charts", link: "/charts", sublinks: [] },
  { text: "Icons", link: "/icon", sublinks: [] },
  { text: "Maps", link: "/map", sublinks: [] },
  { text: "File Manager", link: "/file-manager", sublinks: [] },
  {
    text: "Multiple Level",
    link: null,
    submenu: [
...
const socialTableData = [
  ...
  {
    id: 3,
    icon: "fa-brands fa-y-combinator",
    name: "Combinator",
    count: "326,012",
    span: "text-comb",
  },
...
const upcomingProjectTableData = [
  {
    id: 1,
    day: 14,
    month: "Feb",
...
const taskTableData = [
  ...
  {
    task: "Laravel developer interview",
    date: "5 Apr, 2023",
  },
  {
    task: "Client support",
...
const deadlineTableData = [
  {
    companyName: "Absternet LLC",
    date: "Sep 20, 2021",
    contactPerson: "Donald Risher",
    status: "Deal Won",
    amount: "125K",
  },
  {
  ...
  },
  {
    ...
    date: "Feb 28, 2022",
    contactPerson: "Samantha White",
    status: "Deal Won",
    amount: "180K",
  },
];

const noticeTableData2 = [
  {
    date: "14",
    month: "Feb",
    activity: "Meeting for campaign with sales team",
    time: "12:00am - 03:30pm",
  },
  {
    date: "15",
  ...
  },
  {
    date: "16",
    month: "Feb",
    activity: "Client presentation meeting",
...
const recentActivityTableData = [
  {
    activityName: "Leave Approval Request",
    activityShort: 'From "RuthDyer" UiDesign Leave On Monday 12 Jan 2020.',
    activityTime: "6 min ago",
  },
  {
    activityName: "Work Update",
    activityShort: 'From "RuthDyer" UiDesign Leave On Monday 12 Jan 2020.',
    activityTime: "16 min ago",
  },
  {
    activityName: "Leave Approval Request",
    activityShort: 'From "RuthDyer" UiDesign Leave On Monday 12 Jan 2020.',
...
const upcomingInterviewTableData = [
  {
...
export {
  ...
  recentProjectTableData,
  upcomingProjectTableData,
  pendingWorkTableData,
  invoiceTableData,
  taskTableData,
  noticeTableData,
  deadlineTableData,
  noticeTableData2,
  recentActivityTableData,
  attendanceTableData,
  upcomingInterviewTableData,
