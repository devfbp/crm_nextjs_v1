...
export async function GET(request) {
  ...
  try {
    ...
    let revenue = 0;
    if(revenueAmount._sum.revenue === null){
      revenue = revenueAmount._sum.revenue = 0;
    } else {
      revenue = revenueAmount._sum.revenue = revenueAmount._sum.revenue?.toLocaleString('en-US', { style: 'currency', currency: 'INR' });
    }

    const ListData = [
      {
        id : "1",
        coin : "Total Active Leads",
        amount : totalLeads,
        rate : "",
        subTitle : 'In CRM',
      },
      {
        id : "2",
        coin : "Total Calls Done",
        amount : callsDoneToday,
        rate : "",
        subTitle : 'Today',
      },
      {
        id : "3",
        coin : "Today Total Leads",
        amount : totalLeadsToday,
        rate : "",
        subTitle : 'Today',
      },
      {
      ...
      {
        id : "5",
        coin : "Number of Closures",
        amount : NumberofClosuresDone,
        rate : "",
        subTitle : 'Done  ',
      },
      {
        id : "6",
        coin : "Last Booking done",
        amount : NumberofDaysLastBookingDone,
        rate : "",
