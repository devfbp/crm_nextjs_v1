                            ...
                            {data.map((item) => (
                                <tr key={item?.source_id}>
                                    ...
                                    <td>
                                        ...
                                        <EditAction menu_id={SOURCE_MENU_ID} id={item?.source_id} page="source" setRecords={props?.setRecords} />
                                        <DeleteAction menu_id={SOURCE_MENU_ID} id={item?.source_id} page="source" setRefresh={props?.setRefresh} />
                                        </div>
                                    </td>
                                </tr>
                            ))}
