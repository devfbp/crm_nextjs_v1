        ...
        <div className="card-body">
          <div className="table-filter-option customized-data-table">
            <div className="row g-3">
              <div className="col-xl-10 col-md-9 col-sm-9">
                <div className="row g-3">
                  <div className="col">
              ...
              <div className="col-xl-2 col-md-3 col-sm-3 d-flex justify-content-between">
                <div id="tableSearch">
                ...
                <tr>
                  ...
                  <td>
                    <div className="table-product-card">
                      ...
                      <div className="part-txt">
                        <span className="product-name">
                          Chris Adams Body Spray classNameic Denim
                        </span>
                        <span className="product-category">
