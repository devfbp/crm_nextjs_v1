        ...
        <div className="panel-body">
          <div className="row g-3">
            <div className="col-lg-6">
              ...
              <div className="card mb-20">
                <div className="card-header">Form grid</div>
                <div className="card-body">
                  <div className="row">
                    <div className="col">
                      <input
              ...
              <div className="card mb-20">
                <div className="card-header">Column sizing</div>
                <div className="card-body">
                  <div className="row g-3">
            ...
            <div className="col-lg-6">
              <div className="card mb-20">
                <div className="card-header">Gutters</div>
                <div className="card-body">
              ...
              <div className="card mb-20">
                <div className="card-header">Auto-sizing</div>
                <div className="card-body">
              ...
              <div className="card">
                <div className="card-header">Inline forms</div>
                <div className="card-body">
