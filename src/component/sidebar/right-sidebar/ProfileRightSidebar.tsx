...
const ProfileRightSidebar = () => {
  const { headerSidebarShow, closeHeaderSidebar, handleCheckboxChange } =
    useDigiContext();

  return (
    <div
      className={`profile-right-sidebar ${headerSidebarShow ? "active" : ""}`}
    >
      <button className="right-bar-close" onClick={closeHeaderSidebar}>
