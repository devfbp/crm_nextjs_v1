            ...
            <div className="col-12">
              ...
              <p className="perma-txt" hidden>
                ...
                <input
                  ...
                  id="editPermalink"
                />
                <button className="btn-flush bg-primary" id="editPermaBtn">
                  Edit
                </button>
                <button className="btn-flush bg-success" id="createPerma">
                  OK
                </button>
                <button className="btn-flush bg-danger" id="cancelPerma">
                  Cancel
                </button>
              </p>
            </div>
