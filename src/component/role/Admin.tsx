                            ...
                            {data.map((item) => (
                                <tr key={item?.role_id}>
                                    ...
                                    <td>
                                        ...
                                        <EditAction menu_id={MASTER_ROLE_MENU_ID} id={item?.role_id} page="role" setRecords={props?.setRecords} />
                                        <DeleteAction menu_id={MASTER_ROLE_MENU_ID} id={item?.role_id} page="role" setRefresh={props?.setRefresh} />
                                        </div>
                                    </td>
                                </tr>
                            ))}
