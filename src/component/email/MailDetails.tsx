...
const MailDetails = () => {
  const { mailDetailsOpen, handleMailDetailClose, handleMailOpen } =
    useDigiContext();
    ...
    <div className={`mail-details ${mailDetailsOpen ? "" : "d-none"}`}>
      <div className="mail-body-top d-flex justify-content-between align-items-center mb-10">
        ...
        <div className="right d-flex align-items-center gap-3">
          ...
          <button className="btn-flush expandReply" onClick={handleMailOpen}>
        ...
        <div className="mail-conversation">
          <div className="single-mail">
            ...
            <div className={`mail-body ${firstMail ? "" : "d-none"}`}>
              <p>Dear Sanoar Vai,</p>
              <p>
                As discussed with you over the phone. It would be very helpful
                for me to handle audits if I can enter holidays separately.
                Please get back to me for further explanation.
              </p>
              <p>Regards,</p>
              <p>Farhad Reza</p>
