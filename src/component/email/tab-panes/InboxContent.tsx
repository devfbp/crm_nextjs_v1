...
const InboxContent = () => {
  const { mailDetailsOpen } = useDigiContext();
  ...
  return (
    <>
      ...
      <div className="panel-body email-body-header">
        ...
        <div className="table-filter-option email-table-filters">
            ...
            <div className="col-xxl-4 col-9 col-xs-12">
              <div className="row g-3">
                <div className="col">
                  <form>
                    <Form.Select
                      className="form-control form-control-sm bulk-paceholder"
        ...
        <Tab.Content className="email-tab-content">
          <Tab.Pane
            eventKey="primary"
            className={`tab-pane ${
              activeTab === "primary" ? "show active" : ""
            }`}
          >
            <div
              className={`table-wrapper ${
                mailDetailsOpen ? "mail-opened" : ""
              }`}
            >
          ...
          <Tab.Pane
            eventKey="promotion"
            className={`tab-pane ${
              activeTab === "promotion" ? "show active" : ""
            }`}
          >
            <PromotionContent />
          </Tab.Pane>
