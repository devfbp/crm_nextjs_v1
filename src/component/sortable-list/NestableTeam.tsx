      ...
      <div className="panel">
        ...
        <div className="panel-body">
          <p className="fs-14 pb-1 mb-10">
            Use <code>nested-sortable</code> className to list-group className
            to set a nested list with sortable items where images are attached
            within a list-group-item div element.
          </p>
