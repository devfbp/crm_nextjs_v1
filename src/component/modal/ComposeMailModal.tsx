...
const ComposeMailModal = () => {
  const { showComposeMail, handleComposeMailClose, currentTheme } =
    useDigiContext();
  ...
  return (
    <Modal
      ...
      onHide={handleComposeMailClose}
      size={modalSize}
      centered
    >
      <Modal.Header>
        <h5 style={{ color: currentTheme === "light" ? "#464646" : "inherit" }}>
          New Message
        </h5>
        <div className="btn-box">
          <button
            className="btn btn-sm btn-icon btn-outline-primary"
            onClick={handleComposeMailClose}
          >
            <i className="fa-light fa-minus"></i>
          </button>
          <button
            className="btn btn-sm btn-icon btn-outline-primary d-xl-inline-block d-none"
      ...
      <Modal.Body>
        <form>
          ...
          <input
            type="text"
            className="form-control form-control-sm mb-15 d-none input-cc"
            placeholder="Cc"
          />
          <input
            type="text"
            className="form-control form-control-sm mb-15 d-none input-bcc"
            placeholder="Bcc"
          />
          <input
            type="text"
