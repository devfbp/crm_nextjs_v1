...
const FileDetailsModal = () => {
  const { fileDeatailsModalOpen, handleFileDetailsModalClose } =
    useDigiContext();
  return (
    <Modal
      show={fileDeatailsModalOpen}
      onHide={handleFileDetailsModalClose}
      size="lg"
      centered
    >
      <Modal.Header>
      ...
      <Modal.Footer>
        <Button
          variant="secondary"
          size="sm"
          onClick={handleFileDetailsModalClose}
        >
          Close
        </Button>
