...
function MailDetailsModal() {
  const { showMailModal, handleMailClose, currentTheme } = useDigiContext();
  ...
  return (
    <>
      ...
      >
        <Modal.Header>
          <div
            className="mail-body-top d-flex justify-content-between align-items-center mb-10"
            style={{ width: "100%" }}
          >
            ...
            <div className="right d-flex align-items-center gap-3">
              ...
              <button
                className="btn-flush expandReply"
                onClick={handleMailClose}
              >
            ...
            <div className="mail-top" role="button" onClick={handleFirstMail}>
              <div className="mail-profile">
                ...
                <div
                  className="part-txt"
                  style={{
                    color: currentTheme === "light" ? "#626262" : "#adadad",
                  }}
                >
